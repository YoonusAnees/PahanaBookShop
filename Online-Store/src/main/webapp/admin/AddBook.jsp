...
<head>
    ...
    <title>Add New Book - PahanaBook</title>
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
             <li><a href="AddBook.jsp" class="active"><i class="fas fa-plus-circle"></i>Add Book</a></li>
    ...
    <main class="main-content">
        <div class="form-container">
            ...
            <form action="Book?action=add" method="post" enctype="multipart/form-data" id="bookForm">
                ...
                <div class="form-group">
                    <label for="image"><i class="fas fa-image"></i>Book Cover</label>
                    <div class="file-input-container">
                        <label for="image" class="file-input-label">
                            <i class="fas fa-cloud-upload-alt"></i>
                            <span>Choose book cover image</span>
                        </label>
                        <input type="file" id="image" name="image" class="file-input" accept="image/*" required onchange="previewImage(this)" />
                    </div>
