...
<head>
    ...
    <title>Stationery Management - PahanaBook</title>
    ...
    <style>
        ...
        * {
        ...
        .stationery-table th:first-child {
            border-top-left-radius: 10px;
        }

        .stationery-table th:last-child {
        ...
        .stationery-table tr:last-child td {
            border-bottom: none;
        }

        .stationery-table tr:hover {
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="Book?action=list"><i class="fas fa-book"></i>Manage Books</a></li>
            ...
            <li><a href="Stationery?action=list" class="active"><i class="fas fa-pencil-ruler"></i>Manage Stationery</a></li>
    ...
    <main class="main-content">
        ...
        <header class="header">
            <div class="welcome-text">
                ...
                <p>Manage your stationery inventory efficiently</p>
            </div>
        ...
        <div class="page-header">
            <h2 class="page-title">
                <i class="fas fa-pencil-ruler"></i>Stationery Management
            </h2>
            <a href="AddStationery.jsp" class="add-btn">
                <i class="fas fa-plus-circle"></i>Add New Stationery
            </a>
        </div>
            ...
            <c:choose>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="EditStationery.jsp?id=${s.id}" class="btn btn-edit">
                                                <i class="fas fa-edit"></i>Edit
                                            </a>
                                            <button onclick="confirmDelete('${s.name}', ${s.id})" 
                ...
                <c:otherwise>
                    <div class="empty-state">
                        ...
                        <p>Get started by adding your first stationery item to the collection</p>
                        <a href="AddStationery.jsp" class="add-btn">
                            <i class="fas fa-plus-circle"></i>Add Your First Stationery
                        </a>
                    </div>
                </c:otherwise>
            </c:choose>
    ...
    <script>
        ...
        document.querySelectorAll('.stationery-table tr').forEach(row => {
